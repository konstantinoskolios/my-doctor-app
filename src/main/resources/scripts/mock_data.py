...
#     phone_number = '69' + ''.join(random.choices('0123456789', k=8))  # Make sure it starts with '69' and has 10 digits in total
...
#     """
#     cursor.execute(insert_query, (first_name, last_name, father_first_name, tax_number, social_security_number, phone_number, birthdate))
#
