...
public enum PrescriptionCategoryEnum {
    Cardiovascular(new String[]{"Echocardiogram", "Electrocardiogram (ECG or EKG)", "Stress Test", "Holter Monitor", "Cardiac Catheterization"}),
    Respiratory(new String[]{"Pulmonary Function Test (PFT)", "Chest X-ray", "CT Scan of the Chest", "Bronchoscopy", "Sputum Culture"}),
    Metabolic(new String[]{"Blood Glucose Test", "Cholesterol Panel", "Thyroid Function Test", "Hemoglobin A1c (HbA1c)", "Liver Function Test"}),
    ...
    Geriatric(new String[]{"Geriatric Assessment", "Osteoarthritis Evaluation", "Dementia Screening", "Frailty Assessment", "Polypharmacy Review"});
