...
for _ in range(5000):
    ...
    insert_query = """
    INSERT INTO citizen (id,first_name, last_name, father_first_name, tax_number, social_security_number, phone_number, birthdate)
    VALUES (%s,%s, %s, %s, %s, %s, %s, %s)
    """
    cursor.execute(insert_query, (
        id,first_name, last_name, father_first_name, tax_number, social_security_number, phone_number, birthdate))
